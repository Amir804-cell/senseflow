...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-28 pb-20 md:pt-20 relative overflow-hidden bg-slate-50">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-teal-400/5 rounded-full blur-[120px] pointer-events-none" />
      
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 w-full">
        {/* Text Content */}
        <div className="text-center lg:text-left order-2 lg:order-1">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-full text-slate-600 text-sm mb-8 font-medium shadow-sm animate-fade-in-up">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-[1.1] text-slate-900 tracking-tight animate-fade-in-up delay-100">
            Smart Climate <br />
          ...
          <p className="text-slate-600 mb-10 leading-relaxed text-lg md:text-xl max-w-lg mx-auto lg:mx-0 animate-fade-in-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up delay-300">
            <button onClick={() => scrollTo('features')} className="group px-8 py-4 bg-slate-900 text-white rounded-2xl font-semibold shadow-xl shadow-slate-900/10 hover:shadow-slate-900/20 transition-all hover:-translate-y-1 flex items-center justify-center gap-2">
              Explore Features
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button onClick={() => scrollTo('contact')} className="px-8 py-4 bg-white border border-slate-200 rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition text-slate-700 font-medium shadow-sm hover:shadow-md">
              Contact Sales
            </button>
          </div>
        </div>
